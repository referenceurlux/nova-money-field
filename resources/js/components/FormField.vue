        ...
        <template #field>
            <div class="flex flex-wrap items-stretch w-full relative">
                <input
                    ...
                    type="number"
                    class="flex-1 relative focus:border-blue focus:shadow form-control form-input form-input-bordered rounded-r-none"
                    @input="handleChange"
                    :value="value"
                ...
                <div class="flex -ml-px">
                    <span class="flex items-center bg-gray-100 rounded rounded-l-none px-3 whitespace-no-wrap text-sm form-control form-input-bordered">{{ currentField.currency }}</span>
                </div>
            </div>
        </template>
    </DefaultField>
